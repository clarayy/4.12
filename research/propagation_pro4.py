...
def data_A(datadir,bmname):
    ...
    #nodelist = [2,4,17,18,32,33,38,39,40,42,43,44,45,46,56,58,59,60 ]#dolphins_class1
    #nodelist = [11,83,19,20,23,24,0,205,212,218]  #wiki889按12分类选10个代表节点
    ...
    with open(filename_readme,'a') as f:
        ...
        #f.write('[a,b]='+str(nodelist)+"\n")
        f.write('every node graphs='+str(graphs)+"\n")


def main():

    bmname = 'wiki889_SI_m10'
    path = os.path.join('/home/iot/zcy/usb/copy/new_GNN/rexying_diffpool/diffpool-master/data',bmname)#/home/iot/zcy/usb/copy/
