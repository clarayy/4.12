...
def four_metirc(G,negative):
    ...
    Gc_node = max(nx.connected_components(G), key=len)   #sub_newG的最大连通子图来求Jordan Center     可能为空图
    #print(Gc_node)
...
def main():
    ...
    bmname = 'dolphins_p0.5_ob0.3_fm_m50_BC'
