...
#pycharm中的文件名
bmname = 'trap171_nSIS_z0.1_m50'
path = os.path.join('/home/iot/zcy/usb/copy/new_GNN/new_GNN_class10/diffpool-master/labels',bmname)
...
with open(file_labels,'r') as f1:
    for line in f1.readlines():
        labels.append(int(eval(line.strip('\n'))))
with open(file_preds,'r') as f2:
    for line in f2.readlines():
        preds.append(int(eval(line.strip('\n'))))
