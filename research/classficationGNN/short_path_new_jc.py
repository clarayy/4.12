...
#pycharm中的文件名
bmname = 'food500_nSI_z0.1_m5_c2test'
...
file_labels = path1 +'_labels.txt'
file_preds = path1 + '_preds.txt'
#file_eva_labels = path1+'_labels.txt'
file_val_jordancenter = path1 + '_val_jordancenter.txt'
...
print('平均预测距离：{:.2}'.format(average_distance_preds))
result = {}
...
print('平均约旦距离：{:.2}'.format(average_distance_center))
count = 0
