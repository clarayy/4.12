...
#感染过程
    ...
    if not nx.is_empty(new_G):
        ...
        #distance centrality
        dis_path = dict(nx.shortest_path_length(sub_newG))
        dis_d={}
...
def main():
    ...
    bmname = 'dolphins_SI_z0.5_ob0.5_m100'
    ...
    with open(filename_readme,'w') as f:
        ...
        f.write('dolphins底图，不完全观测节点，观测50%的节点, 包括多种对比方法'+"\n")
