#propagation5_lei_jian_SIR_data.py  中省略了三种方法的对比，在此程序中恢复
import numpy as np
import pandas as pd
...
def main():
    ...
    bmname = 'trap171_cSIR_r4_m50'
    #path = os.path.join('/home/zhang/Documents/pytorch/learn/GraphKernel/rexying_diffpool/diffpool-master/data',bmname)
    path = os.path.join('/home/iot/zcy/usb/copy/new_GNN/new_GNN_class10/diffpool-master/data',bmname)
    ...
    with open(filename_readme,'w') as f:
        ...
        f.write('trap171中验证集，r=4, 感染图节点在25左右，很小，停止传播'+"\n")
